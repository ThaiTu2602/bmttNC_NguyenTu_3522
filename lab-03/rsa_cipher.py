...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        self.ui.BtnGenereteKeys.clicked.connect(self.call_api_gen_keys)
        self.ui.BtnEncypt.clicked.connect(self.call_api_encrypt)
        self.ui.BtnDecypt.clicked.connect(self.call_api_decrypt)
